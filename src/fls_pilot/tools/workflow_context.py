...
WORKFLOW_REGISTRY: dict[str, dict] = {
    ...
    "project_organizer": {
        ...
        "stop_rules": [
            ...
            "Store producer decisions with fl_update_organization_plan_decision before apply.",
            "Check fl_get_organization_status for plan state and rollback ids after apply.",
