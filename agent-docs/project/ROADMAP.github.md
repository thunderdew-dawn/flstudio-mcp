...
- [P2] #35 [P2: Step Sequencer variation and parameter workflow pack](https://github.com/thunderdew-dawn/fls-pilot/issues/35) - write-safe-required
- [P2] #36 [P2: Transient MIDI preview note and chord tools](https://github.com/thunderdew-dawn/fls-pilot/issues/36) - transient

### Experimental/API-dependent

- [P2] #40 [P2: Focused API probe backlog for extension review findings](https://github.com/thunderdew-dawn/fls-pilot/issues/40) - api-dependent
- [P3] #24 [P3: Hook and Motif Coach](https://github.com/thunderdew-dawn/fls-pilot/issues/24) - api-dependent
- [P3] #25 [P3: Automation Analyzer](https://github.com/thunderdew-dawn/fls-pilot/issues/25) - api-dependent, read-only
- [P3] #26 [P3: Automation Pack Generator](https://github.com/thunderdew-dawn/fls-pilot/issues/26) - api-dependent, write-safe-required
- [P3] #27 [P3: A/B Variant Manager](https://github.com/thunderdew-dawn/fls-pilot/issues/27) - write-safe-required
- [P3] #28 [P3: Plugin Replacement Assistant](https://github.com/thunderdew-dawn/fls-pilot/issues/28) - api-dependent
- [P3] #29 [P3: CPU and Performance Review](https://github.com/thunderdew-dawn/fls-pilot/issues/29) - api-dependent, read-only
- [P3] #30 [P3: Compare Project Against Reference Structure](https://github.com/thunderdew-dawn/fls-pilot/issues/30) - read-only
- [P3] #31 [P3: Deep Sample and Loop Intelligence](https://github.com/thunderdew-dawn/fls-pilot/issues/31) - api-dependent
- [P3] #32 [P3: Optional TCP/push-event transport research](https://github.com/thunderdew-dawn/fls-pilot/issues/32) - api-dependent
- [P3] #33 [P3: Piano Roll readback research](https://github.com/thunderdew-dawn/fls-pilot/issues/33) - api-dependent
- [P3] #34 [P3: REC automation write/readback probes](https://github.com/thunderdew-dawn/fls-pilot/issues/34) - api-dependent, write-safe-required
- [P3] #41 [P3: Project metadata and timebase review/probe workflow](https://github.com/thunderdew-dawn/fls-pilot/issues/41) - api-dependent, write-safe-required
...
- [P0] #66 [P0: Release 3.0 readiness checklist](https://github.com/thunderdew-dawn/fls-pilot/issues/66)

### No milestone

- [P1] #13 [P1: Jam-to-Project structured cleanup assistant](https://github.com/thunderdew-dawn/fls-pilot/issues/13) - write-safe-required
...
- [P2] #16 [P2: Arrangement Coach](https://github.com/thunderdew-dawn/fls-pilot/issues/16) - read-only
- [P2] #17 [P2: Energy Curve Analyzer](https://github.com/thunderdew-dawn/fls-pilot/issues/17) - read-only
- [P2] #18 [P2: Transition Review](https://github.com/thunderdew-dawn/fls-pilot/issues/18) - read-only
- [P2] #19 [P2: Sidechain Assistant](https://github.com/thunderdew-dawn/fls-pilot/issues/19) - write-safe-required
- [P2] #20 [P2: Creative Block Breaker](https://github.com/thunderdew-dawn/fls-pilot/issues/20)
- [P2] #21 [P2: Handoff Report](https://github.com/thunderdew-dawn/fls-pilot/issues/21) - read-only
- [P2] #22 [P2: Stem Export Manager](https://github.com/thunderdew-dawn/fls-pilot/issues/22) - read-only
- [P2] #23 [P2: Reference Track Deconstruction](https://github.com/thunderdew-dawn/fls-pilot/issues/23) - read-only
- [P2] #37 [P2: Audio Clip Safe Defaults profiles and 50 percent import option](https://github.com/thunderdew-dawn/fls-pilot/issues/37) - write-safe-required
- [P2] #38 [P2: Reference track isolation review and routing plan](https://github.com/thunderdew-dawn/fls-pilot/issues/38) - read-only
...
- #45 [Rejected: broad UI focus tools and plugin editor open-close controls](https://github.com/thunderdew-dawn/fls-pilot/issues/45) - not_planned
